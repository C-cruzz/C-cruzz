...
Sou estudante de **Ciência de Dados** (2º semestre) e estagiário na área de Dados/BI na Grendene, com foco em Power BI, SQL, BigQuery, GA4, Python, análise de dados e automação de relatórios.
...
-  Estagiário em Dados/BI
-  Área de interesse: Business Intelligence, Data Analytics, automação e tecnologia
-  Atualmente aprofundando conhecimentos em Power BI, modelagem de dados, DAX, Python, SQL e Google Cloud
-  Também possuo base em Front-End, com conhecimentos em HTML, CSS, JavaScript e Node.js
-  Baseado no Brasil
...
- [Site Fisioterapeuta Luisa Mara](https://luisa-fisioterapeuta.netlify.app/)  
  Site desenvolvido para uma fisioterapeuta, apresentando suas especialidades, informações profissionais e canais de contato.
